...
func TestAddItem(t *testing.T) {
	tasks := Tasks{}
	tasks.addItem(Task{"identifier-1", TaskStart, "2016-01-02T15:04:00Z"})
	tasks.addItem(Task{"identifier-2", TaskStart, "2016-01-02T15:04:00Z"})
...
func TestItemToArrayString(t *testing.T) {
	task := Task{"identifier-1", TaskStart, "2016-01-02T15:04:00Z"}
	expectedArrayString := []string{"identifier-1", TaskStart, "2016-01-02T15:04:00Z"}
...
func TestGetByIdentifier(t *testing.T) {
	tasks := Tasks{
		Items: []Task{
			...
			{"identifier-2", TaskStop, "2016-01-02T15:04:00Z"},
		},
	}
